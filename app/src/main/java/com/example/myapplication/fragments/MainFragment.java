...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        dayofW=format1.format(date);

        Calendar calendar = GregorianCalendar.getInstance();
        calendar.setTime(date);
        hourOfD="["+dayofW+"-"+String.valueOf(calendar.get(Calendar.HOUR_OF_DAY))+"]";
    ...
    private void getMarket() {
        ...
        String tag_string_req = "req_get_market";
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_MARKET, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("type", "night");
                params.put("open", session.getMarket_Open());
                params.put("day", dayofW);
                params.put("hour", hourOfD);
                return params;
            }
    ...
    private class MyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public class ItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
            ...
            public void onClick(View view) {
                ...
                // NEED TO DISPLAY PHOTO OF THE MENU!!!!!!!!!!!!!!!!!!!!
